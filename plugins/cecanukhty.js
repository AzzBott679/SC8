...
let handler = async (m, { conn }) => {
    ...
    if (!img) throw img
    await conn.sendFile(m.chat, img, '', '© nih Cecan Ukhtynya jangan lupa subscribe channel https://youtube.com/channel/UCmUhiytK9WMYaOFgdOho_2g👍', m, 0, { thumbnail: await (await fetch(img)).buffer() })
}
